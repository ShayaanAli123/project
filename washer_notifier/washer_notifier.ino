...
// Sensor: MPU-6050 (GY-521), I2C, SDA=GPIO21, SCL=GPIO47, VCC=3V3.

#include <Wire.h>
#include <Adafruit_MPU6050.h>
#include <Adafruit_Sensor.h>

// I2C pins. Both are plain general-purpose GPIOs on the ESP32-S3 with no
// boot-strapping or peripheral role. GPIO 47 sits right next to GPIO 21 on
// the DevKitC-1 header, so this is a physically tidy wiring choice.
